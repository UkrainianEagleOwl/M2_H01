...
from src.constants import STR_EPIC_COMMANDS
...
class ConsoleOutputForUser(OutputForUser):
    ...
    def show_note(self,note = Note):
        ...
        print("Title: {}\nTags: {}\nDescription: {}".format(note.title, tags_str, note.description))
...
output_for_user = ConsoleOutputForUser() #if in console create object console if not create another object